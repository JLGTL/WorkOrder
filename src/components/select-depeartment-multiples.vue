<template>
	<div class="backGrey mainpage">
		...
		<div class="backGrey mat54 searchBox">
			<van-search placeholder="请输入姓名/工号/拼音" v-model="value" :clearable='true' @focus="staffsBack=true" @blur="staffsBack=false" id="myBox" class="search">
		...
		<div class="group backWhite">
			...
			<div class="allscroll2" v-if="scrollList.length>0">
				<div v-if="nodes.length==0 && staffs.length==0" class="nodata">
